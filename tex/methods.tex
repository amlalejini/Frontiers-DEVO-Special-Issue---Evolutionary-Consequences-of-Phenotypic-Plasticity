...
\input{tex/figures/metrics-definitions}
...
We used the lineage from the founding organism to the representative organism (\textit{i.e.}, the representative lineage) for further analysis.
...
Genomes in Avida are linear sequences of instructions, and as such possible mutations can be simulated by substituting other instructions at the desired site.%swapping these instructions. 
