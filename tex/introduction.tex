...
(1) populations experience temporal environmental variation (i.e., a fluctuating environment),
...
Finally, we examine lineages to determine whether adaptive plasticity facilitated the accumulation of cryptic genetic variation that would prove deleterious when the environment changed. %initially unexpressed deleterious genes via cryptic genetic variation by measuring the frequency with which deleterious mutations occur along successful lineages. 
