...
\input{tex/figures/reaction-norms}
...
% @AML: next bit is a little awkward
 evolution of adaptive phenotypic plasticity \citep{clune_investigating_2007,lalejini_evolutionary_2016} and on the evolutionary consequences of fluctuating environments \citep{wilke_evolution_2001,canino-koning_fluctuating_2019}.

Previous work in Avida characterized 

fluctuating environments 

\citep{clune_investigating_2007,lalejini_evolutionary_2016} experimentally demonstrated the \textit{de novo} evolution of adaptive phenotypic plasticity given the following four conditions (as identified by \cite{ghalambor_behavior_2010}): 
...
Here, we build on this previous work to facilitate the evolution adaptive plasticity in Avida, shifting our focus from the evolutionary causes of phenotypic plasticity to investigate its evolutionary consequences in a fluctuating environment.
