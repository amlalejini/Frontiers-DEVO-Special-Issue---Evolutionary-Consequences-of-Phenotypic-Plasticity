...
We did, however, observe small, but statistically significant, differences in each of the following metrics: elapsed generations, mutation counts, mutational robustness, realized mutational robustness, and architectural volatility between PLASTIC and STATIC populations. % (see supplemental material \citealt{supplemental_material}).
