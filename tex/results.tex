...
At the end of our experiment, no dominant genotypes evolved in PLASTIC or STATIC treatments express the \code{poison} instruction; however, the dominant genotype from 14 replicates of the NON-PLASTIC treatment did express the \code{poison} instruction at least once (statistically significant, [stats]).
...
Across all NON-PLASTIC dominant lineages, we found that approximately 49\% (956 out of 1916) mutations that increase \code{poison} execution co-occurred with mutations that change the base task profile ([per-lineage statistically significant relative to PLASTIC or STATIC, stats]); we did not observe instances of co-occurrence in PLASTIC and STATIC lineages.
